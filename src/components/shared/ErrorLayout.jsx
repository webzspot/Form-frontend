  ...
  const getDisplayContent = (code) => {
    switch (code) {
      ...
      case 401: 
        ...
        return {
          title: "Access Denied",
          description: message || "You don't have permission to view this page. Check your subscription status.",
      ...
      default:
        return {
          title: "Oops! Server Error",
          description:  "Our server is having some trouble. We're looking into it.",
          buttonText: "Try Again",
          icon: <AlertCircle size={40} />
        };
    }
