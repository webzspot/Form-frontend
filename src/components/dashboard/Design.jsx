  ...
  return (
    <div className="w-full mb-4">
      <button
        ...
        className="bg-[#2B4BAB] text-white px-4 sm:py-2.5 py-1 text-[13px] sm:text-[16px] rounded-sm font-semibold flex items-center gap-3 w-full justify-center transition-all shadow-lg"
      >
