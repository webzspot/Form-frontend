...
// } from 'react-icons/fa';
// import { Eye } from 'lucide-react'; // add at top
...
//                 {/* Header Section */}
//                  <motion.div className="max-w-7xl mx-auto mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4"
...
//                         </motion.button>
//                          <motion.button
//                             className="flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-700 text-white px-3 py-3 rounded-xl shadow-lg transition-all active:scale-95"
//                             onClick={() => navigate("/admin/forms")} 
//                             whileHover={{ scale: 1.05 }}
//   whileTap={{ scale: 0.95 }}
//                         >
//                         <Eye size={16}/> View All Forms
//                         </motion.button>  
...
// <motion.div
//   className="max-w-7xl flex flex-wrap mx-auto mb-8 gap-4"
//   initial="hidden"
//   animate="visible"
//   variants={{
//     hidden: {},
//     visible: {
//       transition: { staggerChildren: 0.15 } // each card appears after previous
//     }
//   }}
// >
//   {/* Total Users - slide from left */}
//   <motion.div
//     variants={{
//       hidden: { opacity: 0, x: -100 }, // left
//       visible: { opacity: 1, x: 0, transition: { duration: 0.5 } }
//     }}
//     className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex items-center gap-4 min-w-[200px]"
//   >
...
//   {/* Active Users - slide from right */}
//   <motion.div
//     variants={{
//       hidden: { opacity: 0, x: 100 }, // right
//       visible: { opacity: 1, x: 0, transition: { duration: 0.5 } }
//     }}
//     className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex items-center gap-4 min-w-[200px]"
//   >
...
//   {/* Inactive Users - slide from left */}
//   <motion.div
//     variants={{
//       hidden: { opacity: 0, x: -100 }, // left
//       visible: { opacity: 1, x: 0, transition: { duration: 0.5 } }
...
//       <p className="text-2xl font-bold text-gray-600">{inactiveUsersCount}</p>
//     </div>
//   </motion.div>
// </motion.div>
...
//       <td className="px-6 py-4 text-center"><div className="h-6 w-16 bg-slate-200 rounded mx-auto"></div></td>
//       <td className="px-6 py-4"><div className="h-4 bg-slate-200 rounded w-1/2"></div></td>
//       <td className="px-6 py-4 text-center"><div className="h-6 w-6 bg-slate-200 rounded mx-auto"></div></td>
//     </tr>
//     ))
