...
{/* Browser Content Area */}
          <div className="relative w-full h-auto bg-[#0B0F17]">
            <img 
              src={landingpage}
              alt="FormCraft Dashboard Preview"
            ...
            <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-[#0B0F17] to-transparent pointer-events-none"></div>
          </div>
        </div> 
    
        <div className="absolute -inset-4 bg-emerald-500/5 blur-3xl -z-10 rounded-full"></div>
      </div> 
    </div> 
  );
};
