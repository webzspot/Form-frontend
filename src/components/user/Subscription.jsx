            ...
            >
              ...
              {plan.id === "FREE" ? (
                ...
                <button 
                  ...
                  className="w-full py-4 rounded-sm font-bold text-sm flex items-center justify-center gap-2 transition-all bg-[#2B4BAB] text-white hover:brightness-110 shadow-md shadow-[#2B4BAB]/20"
                >
