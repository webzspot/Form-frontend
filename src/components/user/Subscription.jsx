...
// //     const res = await axios.post(
// //       `${API_BASE}/subscription/create`,
// //       { planId: "11649138-0345-4136-8745-86d63f5f3552" }, 
// //       { 
// //         headers: { 
// //           Authorization: `Bearer ${currentToken}` 
// //         } 
...
//       console.log(res)
//       // Based on your console log: res.data.data.plan contains "PRO", "FREE", etc.
//       const planData = res.data?.data?.plan?.name;
...
//     <>
//       {standalone && <UserNavbar />}
//       <div className="min-h-screen  w-full relative flex flex-col bg-[#F5F6F8] font-['DM_Sans']">
//        <main className=" mt-8 mb-8  max-w-7xl mx-auto px-4 md:px-6 bg-white rounded-md   pt-12 pb-20">
...
//          <div className="flex flex-wrap  justify-center gap-12 ">
//  {availablePlans.map((plan, i) => {
//   const isActive = userPlan === plan.name?.toUpperCase();
//   const isFreePlan = plan.planType?.toUpperCase() === "FREE";
...
//       transition={{ delay: i * 0.1 }}
//       viewport={{ once: true }}
//       className={`relative bg-white border rounded-md p-8 flex flex-col transition-all duration-300 hover:shadow-xl w-full md:w-[360px] ${plan.planType === 'PRO' ? 'border-[#2B4BAB] border-2 shadow-lg scale-105' : 'border-gray-200'}`}
//     >
//       {plan.planType === 'PRO' && (
...
//       <div className="mt-auto">
//         {isActive ? (
//           <div className="w-full py-4 rounded-md font-bold text-sm flex items-center justify-center gap-2 border border-[#2B4BAB] text-[#2B4BAB] bg-[#2B4BAB]/5">
//             <Check size={18} /> Current Plan
//           </div>
//         ) : isFreePlan ? (
//           <button 
//             disabled
//             className="w-full py-4 rounded-md font-bold text-sm flex items-center justify-center bg-gray-100 text-gray-400 cursor-not-allowed border border-gray-200"
//           >
//             Default Plan
//           </button>
//         ) : (
