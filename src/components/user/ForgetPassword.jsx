...
import { Rocket, Mail, ArrowRight, CheckCircle2, AlertCircle, X } from "lucide-react";
...
const ForgotPassword = () => {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://formbuilder-saas-backend.onrender.com/forgot-password", 
        { email }
      );
  ...
  const testimonials = [
    ...
    },
    {
      ...
      name: "Michael Chen",
      initials: "MC",
      text: "The security features give me peace of mind with my data.",
          ...
          <AnimatePresence>
            {toast.show && (
              <motion.div
                ...
                className={`fixed top-5 right-5 z-50 flex items-center gap-3 px-4 py-3 rounded-md shadow-2xl border ${
                  toast.type === "success" 
