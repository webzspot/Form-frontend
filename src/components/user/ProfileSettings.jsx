...
const ProfileSettings = () => {
  ...
  const labelClasses = "text-[11px] font-bold uppercase tracking-[0.1em] mb-1 text-[#2B4BAB]/60";
  const valueClasses = "text-lg font-semibold text-slate-800";
  const inputClasses = "w-full px-5 py-3.5 rounded-2xl border border-slate-200 outline-none focus:border-[#2B4BAB] focus:ring-4 focus:ring-[#2B4BAB]/5 transition-all font-medium bg-white";
