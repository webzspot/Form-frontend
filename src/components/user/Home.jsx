    ...
    <div className={`min-h-screen flex flex-col ${isDarkMode ? 'bg-[#0a0a0a]' : 'bg-[#F8F9FB]'}`}>
      ...
      <main className="flex-grow p-4 md:p-8">
        <header className="mb-8">
          ...
          <p className="text-gray-500">Design your data collection flow. Add and configure input fields for your form.</p>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
          
          {/* LEFT COLUMN: FIELD TYPES */}
          <section className="md:col-span-2 bg-white rounded-xl border border-gray-200 p-4 shadow-sm min-h-[500px]">
            <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">Field Types</h3>
          ...
          <section className="md:col-span-5 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setlabelname(e.target.value)}
                  placeholder="e.g. Full Name"
                  className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-[#2B4BAB]/20 focus:border-[#2B4BAB] outline-none transition-all"
                />
              </div>
              ...
              <div className="pt-4">
                ...
                <div className="p-4 border border-dashed border-gray-300 rounded-lg bg-gray-50">
                  <label className="text-xs font-medium text-gray-500 mb-1 block">{labelname || "Field Label"}</label>
                  <input disabled className="w-full h-10 bg-white border border-gray-200 rounded-md" />
                </div>
              </div>
          ...
          <section className="md:col-span-5 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden min-h-[600px]">
              ...
              <AnimatePresence>
                {previewFields.map((field, idx) => (
                  ...
                  >
                    ...
                    {field.type === "DATE" ? (
                       <input type="text" placeholder="mm/dd/yyyy" className="w-full p-2 border border-gray-200 rounded-md text-sm text-gray-400" disabled />
                    ) : field.type === "DROPDOWN" ? (
                      <div className="w-full p-2 border border-gray-200 rounded-md text-sm text-gray-400 flex justify-between">
                        Select an option <ChevronDown size={14} />
                      </div>
                    ) : (
                      <input type="text" placeholder={field.placeholder || "Enter text..."} className="w-full p-2 border border-gray-200 rounded-md text-sm" disabled />
                    )}
                  </motion.div>
                ))}
              </AnimatePresence>
